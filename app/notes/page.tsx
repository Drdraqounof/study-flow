        ...
        <div className="flex-1">
          <div className="p-4">
            ...
            >
              ...
              <span className="font-medium text-black">New Project</span>
            </button>
          </div>
          <div className="flex-1 overflow-y-auto px-4">
            <div className="mb-2 px-2 text-xs font-semibold text-black uppercase">
              Recent Projects
            </div>
            {projects.map((project) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-black">{project.lastEdited}</div>
                </div>
              </div>
            ))}
          </div>
          ...
          {selectedProject ? (
                ...
                <div className="max-w-4xl mx-auto bg-white shadow-lg" style={{ minHeight: '11in' }}>
                  <div className="p-16">
                    <textarea
                      ...
                      className="w-full h-full min-h-[800px] text-black focus:outline-none resize-none"
            ...
            <div className="p-8 overflow-y-auto">
              <div className="max-w-6xl mx-auto">
                <div className="mb-6">
                  <h2 className="text-2xl font-bold text-black mb-2">Start a new project</h2>
                  <p className="text-black">Choose a template to get started</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                  {formats.slice(0, 3).map((format) => (
                    ...
                    >
                      ...
                      <div className="p-4">
                        <h3 className="font-semibold text-black mb-1">{format.name}</h3>
                        <p className="text-sm text-black">{format.description}</p>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="mb-6">
                  <h2 className="text-xl font-bold text-black mb-4">Recent Projects</h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {projects.map((project) => (
                    ...
                    >
                      ...
                      <div className="p-4">
                        <h3 className="font-semibold text-black mb-1 truncate">{project.name}</h3>
