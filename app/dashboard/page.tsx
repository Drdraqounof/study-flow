  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="flex-1 p-8">
        ...
        <p className="text-black mb-6">Here's what's happening with your studies today.</p>
        {/* Stat Cards */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-2">
            <CardContent className="p-6">
              <h3 className="font-semibold mb-4 text-black">Recent Activity</h3>
  ...
  return (
    <Link
      ...
      className={`flex items-center gap-3 px-4 py-2 rounded-lg cursor-pointer ${
        active ? "bg-indigo-50 text-indigo-600" : "text-black hover:bg-gray-100"
      }`}
    >
      {icon}
      <span>{label}</span>
  ...
  return (
    <div className="flex justify-between items-center py-3 border-b last:border-none">
      <div>
        ...
        <p className="text-sm text-black">{type} • {time}</p>
      </div>
      {status && (
