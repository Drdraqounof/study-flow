    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f9fafb' }}>
        <div style={{ maxWidth: 400, width: '100%', background: '#fff', borderRadius: 16, boxShadow: '0 4px 24px #0001', padding: 32 }}>
          <h2 style={{ color: '#000', marginBottom: 24, textAlign: 'center' }}>Login to StudyFlow</h2>
          {error && (
            <div style={{ color: '#000', background: '#fef2f2', border: '1px solid #fecaca', borderRadius: 8, padding: '12px 16px', marginBottom: 24, display: 'flex', alignItems: 'center', gap: 8 }}>
              <AlertCircle size={20} style={{ marginRight: 8 }} />
              {error}
            </div>
          )}
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <label htmlFor="login-email" style={{ fontWeight: 500, color: '#000' }}>Email</label>
            <input
              id="login-email"
              type="email"
              value={email}
      ...
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f9fafb' }}>
        <div style={{ maxWidth: 400, width: '100%', background: '#fff', borderRadius: 16, boxShadow: '0 4px 24px #0001', padding: 32 }}>
          ...
          <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <label htmlFor="signup-name" style={{ fontWeight: 500, color: '#000' }}>Full Name</label>
            <input
              id="signup-name"
              type="text"
              value={name}
            ...
            />
            <label htmlFor="signup-email" style={{ fontWeight: 500, color: '#000' }}>Email</label>
            <input
              id="signup-email"
              type="email"
              value={email}
              ...
              style={{ padding: 10, borderRadius: 6, border: '1px solid #e5e7eb', marginBottom: 8 }}
            />
            <label htmlFor="signup-password" style={{ fontWeight: 500, color: '#000' }}>Password</label>
            <input
              id="signup-password"
              type="password"
              value={password}
